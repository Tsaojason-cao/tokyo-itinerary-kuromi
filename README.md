...
1. 访问首页查看6天行程概览
2. 点击任意天数卡片查看详细行程
3. 每个景点都有详细的拍照姿势和美食推荐

### 使用模块化规划器
1. 点击首页的"开始规划"按钮
2. **Step 1**: 选择你的住宿区域
3. **Step 2**: 选择想去的景点（可使用标签筛选）
4. **Step 3**: 查看自动生成的最优路线
5. 点击"在Google Maps中查看"进行导航
...
- **开发服务器**: https://3000-irz0hv97cxae64f57tn5a-3cfd92ec.sg1.manus.computer
