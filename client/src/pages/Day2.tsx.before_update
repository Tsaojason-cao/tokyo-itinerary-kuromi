...
export default function Day2() {
  ...
  const progress = (checkedSpots.size / 23) * 100;
  ...
  const spots = [
    {
      ...
      title: "ookini和服租赁",
      titleJa: "おおきに着物レンタル",
      titleEn: "ookini Kimono Rental",
      location: "浅草雷门店",
      icon: "👘",
      lat: 35.7106,
      lng: 139.7967,
      history: "ookini是浅草地区知名的和服租赁店，提供多种风格的和服选择，包括传统和服、蕾丝和服等现代款式。店铺位于雷门附近，交通便利，提供专业的穿衣服务和发型设计。",
      special: "💡 已预约2026年2月7日09:30！预约套餐：蕾丝和服（含精致发型）5,500日元 + 领口蕾丝花边550日元 + 腰间蕾丝花边550日元 + 日系轻透妆容5,500日元，总计12,100日元。需在20:00前归还。",
      photoTips: [
        "试衣过程：拍摄穿和服的过程，记录美好瞬间",
        "镜前自拍：在店内镜子前拍摄穿好和服后的效果",
        "发型特写：拍摄精致的日式发型和发饰",
        "店铺外观：在店铺门口拍照留念",
        "和服细节：拍摄蕾丝花边等精美细节"
      ],
      femalePoses: [
        "【镜前姿势】站在镜子前，一手轻提袖子展示蕾丝花边，侧身45度看镜头",
        "【发型展示】侧脸或背面拍摄，展示精致的日式发型和发饰",
        "【旋转姿势】轻轻旋转身体，让和服裙摆自然展开，拍摄动态美",
        "【细节特写】拍摄领口和腰间的蕾丝花边细节，一手轻触装饰",
        "【开心表情】双手轻提和服两侧，做开心的表情，展示期待感"
      ],
      couplePoses: [
        "【帮忙整理】男生帮女生整理和服或发饰，温馨互动",
        "【镜前合影】两人在镜子前合影，通过镜子拍摄",
        "【欣赏姿势】男生站在旁边欣赏穿好和服的女生，女生害羞微笑",
        "【牵手出门】穿好和服后牵手准备出门，在店门口拍摄",
        "【对比照】拍摄换装前后的对比照，记录变化"
      ],
      food: ["附近便利店", "浅草咖啡厅"],
      bookingInfo: {
        ...
        plan: "蕾丝和服",
        items: [
          { name: "蕾丝｜送精致发型", quantity: 1, price: 5500 },
          { name: "选购｜领口蕾丝花边", quantity: 1, price: 550 },
          { name: "选购｜腰间蕾丝花边", quantity: 1, price: 550 },
          { name: "选购｜日系轻透妆容", quantity: 1, price: 5500 }
        ],
        totalPrice: 12100,
        mapUrl: "https://maps.app.goo.gl/QEHGAoWTajBNoS5u9",
        returnTime: "20:00前归还"
      }
    },
    {
